...
public class CameraSource {
    ...
    private static final String TAG = "OpenCameraSource"; //NON-NLS
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    Log.d(TAG, "Frame processing thread interrupted on release."); //NON-NLS
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    Log.e(TAG, "Failed to clear camera preview: " + e); //NON-NLS
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    public int doZoom(float scale) {
        synchronized (mCameraLock) {
            ...
            if (!parameters.isZoomSupported()) {
                Log.w(TAG, "Zoom is not supported on this device"); //NON-NLS
                return currentZoom;
            }
    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                Log.i(TAG, "Camera focus mode: " + mFocusMode + " is not supported on this device."); //NON-NLS NON-NLS
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes().contains(
                ...
                Log.i(TAG, "Camera flash mode: " + mFlashMode + " is not supported on this device."); //NON-NLS NON-NLS
            }
        }
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        if (validPreviewSizes.size() == 0) {
            Log.w(TAG, "No preview sizes have a corresponding same-aspect-ratio picture size"); //NON-NLS
            for (android.hardware.Camera.Size previewSize : supportedPreviewSizes) {
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                Log.e(TAG, "Bad rotation value: " + rotation); //NON-NLS
        }
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    if (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            Log.d(TAG, "Frame processing loop terminated.", e); //NON-NLS
                            return;
                        }
                    }
                ...
                try {
                    ...
                    Log.e(TAG, "Exception thrown from receiver.", t); //NON-NLS
                } finally {
